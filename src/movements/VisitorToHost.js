...
import { HostToVisitor } from "./HostToVisitor.js";


export class VisitorToHost extends Movement{
    constructor(scene, sourceContainer, targetContainer){
        super(scene);
        this.id = "visitorToHost";
    ...
    execute(){
        ...
        this.scene.tweens.add({
            ...
            onComplete: ()=>{
                ...
                const command = new HostToVisitor(this.scene, targetContainer, sourceContainer);
