export class Turn2Progress{
    ...
    add(){
        ...
        this.msg1Appendix = this.scene.add.text(this.msg1.x+this.msg1.displayWidth, this.y, " First Cards",{fontSize: 22, fontFamily: "myOtherFont", color: "gold"})
            .setOrigin(0);
        ...
        this.msg2 = this.scene.add.text(this.x, this.msg1.y+this.msg1.displayHeight, 0, {fontSize: 30, fontFamily: "myOtherFont", color: "white"})
            .setOrigin(0);
        this.msg2Appendix = this.scene.add.text(this.msg2.x+this.msg2.displayWidth, this.msg2.y, " Second Cards",{fontSize: 22, fontFamily: "myOtherFont", color: "gold"})
            .setOrigin(0);
        ...
        this.msg3 = this.scene.add.text(this.x, this.msg2.y+this.msg2.displayHeight, 0, {fontSize: 30, fontFamily: "myOtherFont", color: "white"})
            .setOrigin(0);
        this.msg3Appendix = this.scene.add.text(this.msg3.x+this.msg3.displayWidth, this.msg3.y, " Third Cards",{fontSize: 22, fontFamily: "myOtherFont", color: "gold"})
            .setOrigin(0);
    ...
    clearAll(){
        console.log("clearing old progress message for level 2")
